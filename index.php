              ...
              <div class="tabela-responsiva-Ponto-atendimento">
                ...
                <?PHP
                    ...
                    <tr>
                        ...
                        <td><div class="toggle-btn ativo"><div class="circulo"><a href="./excluir_guiche.php?id_guiche='.$usuario->id_guiche.'"class="btn btn-danger"> <i class="bi bi-trash"></i></div></td>
                    </tr>
                    ';
                    }
                ?>
